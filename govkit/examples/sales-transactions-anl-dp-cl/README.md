# sales-transactions-anl-dp-cl

> Data Product `DP-SAL-TRANSACTIONS-CL-001` · dominio **sales** / subdominio **transactions** · país **cl**
...
| Rol | Responsable |
|---|---|
| Business Owner | ana.perez@cencosud.com |
